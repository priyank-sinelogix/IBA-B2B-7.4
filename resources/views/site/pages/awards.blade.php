...
<div class="wrap section">
    ...
    <div class="card-grid awards-grid">
        ...
        <div class="badge-card"><img class="badge-icon" src="{{ asset('images/site/Awards/Award/IMAGES_Ecommerce_Awards_2025_Excellence_In_Ecommerce_Innovation_Logo.png') }}" alt=""><h4>IMAGES eCommerce Awards</h4><p>Recognized for excellence in eCommerce innovation and digital transformation.</p><div class="year">2023</div></div>
        ...
        <div class="badge-card"><img class="badge-icon" src="{{ asset('images/site/Awards/Award/IMAGES_Fashion_Awards_25th_Logo_PNG.png') }}" alt=""><h4>Images Most Admired Fashion Innovation of the Year</h4><p>Honoured for Pioneering Use of Fashion Technology.</p><div class="year">2025</div></div>
        <div class="badge-card"><img class="badge-icon" src="{{ asset('images/site/Awards/Award/combined_award_logos.png') }}" alt=""><h4>Recognized at the Grand Idea Challenge 2021</h4><p>IBA Crafts Pvt. Ltd. received Second-Place Recognition at the Grand Idea Challenge under the Smart Manufacturing theme on 26 June 2021.</p><div class="year">2021</div></div>
        ...
        <div class="badge-card"><img class="badge-icon" src="{{ asset('images/site/Awards/Award/SME_Empowering_India_Awards_Excellence_in_Manufacturing_Logo.png') }}" alt=""><h4>SME – Empowering India Awards | Excellence in Manufacturing</h4><p>Proudly honored with the SME – Empowering India Award for Excellence in Manufacturing, presented by the Hon’ble Textile Minister of India. </p><div class="year">2024</div></div>
        ...
        <div class="badge-card"><img class="badge-icon" src="{{ asset('images/site/Awards/Award/Top100.png') }}" alt=""><h4>Top 100 Startups to Watch Out for 2025</h4><p>Moomaya (By IBA Crafts), led by Nitin Kapoor, was featured among Forbes India’s Top 100 Startups to Watch Out for 2025. </p><div class="year">2025</div></div>
        <div class="badge-card"><img class="badge-icon" src="{{ asset('images/site/Awards/Award/BuisnessWorld.png') }}" alt=""><h4>BW Retail World 40 Under 40 Award</h4><p>Proudly recognized among BW Retail World’s 40 Under 40, an esteemed recognition celebrating young leaders who are shaping the future of India’s retail industry through innovation, entrepreneurial vision, leadership, and business excellence.</p><div class="year">2023</div></div>
    </div>
</div>
