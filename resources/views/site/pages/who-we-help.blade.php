...
@section('og_image', 'images/site/WhoWeHelp/WhoWeHelpBanner.jpg')
...
<section class="wrap whh-hero">
    <img class="whh-hero-bg" src="{{ asset('images/site/WhoWeHelp/WhoWeHelpBanner.jpg') }}" alt="Fashion brands supported by Sewgo's manufacturing platform">
    <div class="whh-hero-content">
        ...
        <div class="mini-stats">
            <div class="mini-stat"><img src="{{ asset('images/site/WhoWeHelp/BannerIcon/ManufacturedIn24hrs.png') }}" alt="" loading="lazy"><div><strong>Manufactured in 24–48 Hours</strong></div></div>
            <div class="mini-stat"><img src="{{ asset('images/site/WhoWeHelp/BannerIcon/MOQ1.png') }}" alt="" loading="lazy"><div><strong>MOQ 1 As low as 1 piece</strong></div></div>
            <div class="mini-stat"><img src="{{ asset('images/site/WhoWeHelp/BannerIcon/40Countries.png') }}" alt="" loading="lazy"><div><strong>40+ Countries We ship worldwide</strong></div></div>
            <div class="mini-stat"><img src="{{ asset('images/site/WhoWeHelp/BannerIcon/SustainableByDesign.png') }}" alt="" loading="lazy"><div><strong>Sustainable By Design</strong></div></div>
        </div>
    </div>
</section>

<div class="wrap section" style="padding-top:10px;">
    <div class="section-head"><h2>Built for Different Business Types</h2></div>
    <div class="card-grid who-we-help-grid">
        <div class="info-card">
            <div class="icon-circle"><img src="{{ asset('images/site/WhoWeHelp/icon/D2cFashionStartups.png') }}" alt="" loading="lazy"></div>
        ...
        <div class="info-card">
            <div class="icon-circle"><img src="{{ asset('images/site/WhoWeHelp/icon/EstablishedFashionBrands.png') }}" alt="" loading="lazy"></div>
        ...
        <div class="info-card">
            <div class="icon-circle"><img src="{{ asset('images/site/WhoWeHelp/icon/OnlineRetailersMarketplaces.png') }}" alt="" loading="lazy"></div>
        ...
        <div class="info-card">
            <div class="icon-circle"><img src="{{ asset('images/site/WhoWeHelp/icon/InfluencersCreatorLedLabels.png') }}" alt="" loading="lazy"></div>
        ...
        <div class="info-card">
            <div class="icon-circle"><img src="{{ asset('images/site/WhoWeHelp/icon/PrivateLabelWhiteLabelBuyers.png') }}" alt="" loading="lazy"></div>
...
<div class="wrap section" style="">
    ...
    <div class="icon-grid supports-grid">
        <div class="icon-card"><div class="icon-circle"><img src="{{ asset('images/site/WhoWeHelp/SupportBusinessType/DesignLibraryAccess.png') }}" alt="" loading="lazy"></div><h3>Design Library Access</h3><p>Access 1000+ ready-to-produce styles or share your own designs — we make it real.</p></div>
        <div class="icon-card"><div class="icon-circle"><img src="{{ asset('images/site/WhoWeHelp/SupportBusinessType/SmallBatchToScale.png') }}" alt="" loading="lazy"></div><h3>Small Batch to Scale</h3><p>Begin with MOQ 1, test the market, then scale production seamlessly.</p></div>
        <div class="icon-card"><div class="icon-circle"><img src="{{ asset('images/site/WhoWeHelp/SupportBusinessType/MultiSkuFlexibility.png') }}" alt="" loading="lazy"></div><h3>Multi-SKU Flexibility</h3><p>Produce multiple styles, sizes, colors &amp; prints in one order, without complexity.</p></div>
        <div class="icon-card"><div class="icon-circle"><img src="{{ asset('images/site/WhoWeHelp/SupportBusinessType/GlobalFulfillmentSupport.png') }}" alt="" loading="lazy"></div><h3>Global Fulfillment Support</h3><p>We handle production, quality, packaging &amp; worldwide shipping — end to end.</p></div>
    </div>
</div>
...
<div class="wrap section" style="padding-top:0;">
    ...
    <div class="icon-grid cols-6 why-model-grid">
        <div class="icon-card"><div class="icon-circle"><img src="{{ asset('images/site/WhoWeHelp/ModelBusinessTypes/LowInventoryRisk.png') }}" alt="" loading="lazy"></div><h3>Low Inventory Risk</h3><p>No bulk orders. No unsold stock.</p></div>
        <div class="icon-card"><div class="icon-circle"><img src="{{ asset('images/site/WhoWeHelp/ModelBusinessTypes/FasterLaunches.png') }}" alt="" loading="lazy"></div><h3>Faster Launches</h3><p>Go from design to delivered in 24–48 hrs.</p></div>
        <div class="icon-card"><div class="icon-circle"><img src="{{ asset('images/site/WhoWeHelp/ModelBusinessTypes/NoDeadStock.png') }}" alt="" loading="lazy"></div><h3>No Dead Stock</h3><p>We produce only what you sell.</p></div>
        <div class="icon-card"><div class="icon-circle"><img src="{{ asset('images/site/WhoWeHelp/ModelBusinessTypes/DemandLedProduction.png') }}" alt="" loading="lazy"></div><h3>Demand-Led Production</h3><p>Real-time, on-demand manufacturing.</p></div>
        <div class="icon-card"><div class="icon-circle"><img src="{{ asset('images/site/WhoWeHelp/ModelBusinessTypes/BetterCashFlow.png') }}" alt="" loading="lazy"></div><h3>Better Cash Flow</h3><p>Pay for what sells, not what sits.</p></div>
        <div class="icon-card"><div class="icon-circle"><img src="{{ asset('images/site/WhoWeHelp/ModelBusinessTypes/FlexibilityInSizesColorsPrints.png') }}" alt="" loading="lazy"></div><h3>Flexibility in Sizes, Colors, Prints</h3><p>Unlimited combinations. One efficient system.</p></div>
    </div>
</div>
...
<div class="wrap" style="padding-bottom:60px;">
    <div class="cta-band-final whh-cta-final" style="margin:0; background: linear-gradient(120deg, #0a3830 0%, #0e5947 55%, #12735a 100%);">
        <img class="whh-cta-icon" src="{{ asset('images/site/WhoWeHelp/CtaBox.png') }}" alt="" loading="lazy">
